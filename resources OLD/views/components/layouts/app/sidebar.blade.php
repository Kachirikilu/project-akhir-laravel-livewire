        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="academic-cap" :href="route('program-studi-management')" :current="request()->routeIs('prodi-management')" wire:navigate>{{ __('Study Program') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
