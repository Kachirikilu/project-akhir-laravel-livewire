    ...
    <div class="ml-auto">
        <flux:dropdown>
            ...
            <flux:menu class="min-w-48">
                ...
                <flux:menu.item wire:click="showAddModal('admin')" class="cursor-pointer !text-red-600 hover:!bg-red-50">
                ...
                <flux:menu.item wire:click="showAddModal('dosen')" class="cursor-pointer !text-lime-600 hover:!bg-lime-100">
                ...
                <flux:menu.item wire:click="showAddModal('mahasiswa')" class="cursor-pointer !text-cyan-600 hover:!bg-cyan-50">
                ...
                <flux:menu.item wire:click="showAddModal('file')" class="cursor-pointer !text-green-600 hover:!bg-green-50">
