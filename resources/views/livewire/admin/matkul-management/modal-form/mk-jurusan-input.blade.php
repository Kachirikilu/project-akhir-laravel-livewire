<div class="space-y-4">
    <div>
        <div class="grid sm:grid-cols-6 gap-1 items-end">
            ...
            <div class="sm:col-span-2">
                @include('livewire.admin.matkul-management.modal-form.partial.kode-mk', ['kodeString' => 'selected_kode_jr'])
            </div>
    ...
    @include('livewire.admin.global.modal-form.search-input-array-form', [
        ...
        'nameXParent' => 'Jurusan',
        'wireLoading' => 'selectJurusan, resetJurusanInput, selectJurusanForFilter, resetJurusanFilter',
    ])
