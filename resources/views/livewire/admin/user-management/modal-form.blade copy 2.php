<flux:modal 
    ...
    class="sm:w-full md:w-3xl max-w-4xl h-[95vh]"
>
            ...
            <form @input="isDirty = true" wire:submit.prevent="{{ $isEditing ? 'updateUser' : 'saveUser' }}" id="userForm">
                ...
                <div class="p-4 bg-white shadow-sm rounded-lg border border-gray-100 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <flux:icon.envelope variant="mini" class="text-gray-400" />
                            </div>
                            <input wire:model.live.debounce.500ms="email" type="email" id="email" placeholder="contoh@domain.com"
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <flux:icon.lock-closed variant="mini" class="text-gray-400" />
                            </div>
                            <input wire:model.live.debounce.500ms="password" type="password" id="password"
                ...
                <div class="p-4 mt-4 bg-white shadow-sm rounded-lg border border-gray-100 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <flux:icon.user variant="mini" class="text-gray-400" />
                            </div>
                            <input wire:model.live.debounce.500ms="name" type="text" id="name"
                    ...
                    @if ($roleType === 'dosen')
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <flux:icon.identification variant="mini" class="text-gray-400" />
                                </div>
                                <input wire:model.live.debounce.500ms="nip" type="text" id="nip"
                    ...
                    @elseif($roleType === 'mahasiswa')
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input wire:model.live.debounce.500ms="nim" type="text" id="nim"
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <flux:icon.calendar-days variant="mini" class="text-gray-400" />
                                </div>
                                <input wire:model.live.debounce.500ms="tahun_angkatan" type="number" id="tahun_angkatan"
                            ...
                            @forelse ($prodi_results as $prodi)
                                <div wire:key="prodi-{{ $prodi['id'] }}"
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span
                                            class="text-[10px] bg-indigo-500 text-white px-2 py-1 rounded-md text-gray-400 ml-2">
                                            ID: {{ $prodi['id'] }}
                                        </span>
                                    </div>
                                </div>
