<div x-data="{ activeTab: @entangle('switchTable') }" class="mb-6 p-4 bg-white rounded-lg shadow-md border border-gray-100">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-8 mt-2 gap-2 items-center w-full">
        {{-- @if ($switchTable !== 'fakultas') --}}
            <div class="sm:col-span-4 relative">
                @include('livewire.admin.global.search-and-filters.secondary-search-alpine', [
