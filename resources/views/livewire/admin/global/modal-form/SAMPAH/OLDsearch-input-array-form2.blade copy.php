<div class="relative" x-data="{
    ...
    parentSelectedId: @entangle('parentIdString').live,
    ...
    <div class="relative">
        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <div wire:loading.remove wire:target="{{ $wireLoading }}">
        ...
        <input x-model="search" autocomplete="off" type="text" 
            ...
            :placeholder="isParentReady ? 'Cari dan tambahkan {{ $nameXString }}...' : 'Pilih {{ $nameXParent }} terlebih dahulu...'"
    ...
    <div x-show="open && isParentReady" x-cloak x-collapse
        class="bg-[var(--main-pop-up-color)] border-[var(--focus-color)] border absolute left-0 right-0 z-[110] mt-1 rounded-lg shadow-2xl max-h-60 overflow-y-auto custom-scrollbar">
