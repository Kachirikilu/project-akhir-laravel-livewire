...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('kelas-management') }}" wire:navigate
        ...
        <div>
            ...
            <p class="text-[var(--contrast-main-text)] opacity-70">Manajemen jadwal dan detail untuk kelas ini.</p>
        </div>
    </div>
    ...
    <div
        ...
        <div class="flex flex-col gap-1">
            <span class="text-xs uppercase tracking-wider text-[var(--contrast-main-text)] opacity-60 font-bold">Kode
                Kelas</span>
            <span class="text-lg font-semibold text-[var(--focus-color)]">{{ $kelas->kode ?? '-' }}</span>
        </div>
        <div class="flex flex-col gap-1">
        ...
        <div class="flex flex-col gap-1">
            ...
            <span class="text-xs text-[var(--contrast-main-text)] opacity-70">{{ $kelas->kode_pr ?? '---' }}</span>
        </div>
        <div class="flex flex-col gap-1">
