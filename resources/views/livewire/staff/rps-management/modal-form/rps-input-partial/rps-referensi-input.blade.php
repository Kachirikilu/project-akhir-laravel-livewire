<div
    ...
    <div class="relative">
        ...
        @include('livewire.global.modal-form.search-input-ref-array-form', [
            'alpine' => 'rps',
            'xResults' => $refResults,
                ...
                <div class="space-y-3">
                    ...
                    <template x-for="ref in $store.rps.ref_cpmk" :key="'main-' + ref.id">
                        <div x-data="{ expanded: false }"
                            class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden transition-all hover:border-blue-300 dark:hover:border-blue-800 shadow-sm">
            ...
            <div class="space-y-6 sm:col-span-2">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-zinc-500 uppercase tracking-widest mt-1">Detail Sumber per Pertemuan
                        </p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <template x-for="ref in $store.rps.ref_scpmk" :key="'sub-' + ref.id">
                        <div x-data="{ expanded: false }"
                            class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden transition-all hover:border-emerald-300 dark:hover:border-emerald-800 shadow-sm">
