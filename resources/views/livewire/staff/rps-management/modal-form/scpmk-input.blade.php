<div>
    ...
    @include('livewire.staff.rps-management.modal-form.scpmk-partial.scpmk-materi-input')
    @include('livewire.staff.rps-management.modal-form.scpmk-partial.scpmk-metode-input')
    @include('livewire.staff.rps-management.modal-form.scpmk-partial.scpmk-ref-input')
