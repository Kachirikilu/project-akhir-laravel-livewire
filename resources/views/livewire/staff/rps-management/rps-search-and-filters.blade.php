<div x-data="{  activeTab: @entangle('switchTable'), activeFilter: @entangle('filter') }" class="bg-[var(--main-table-color)] border-[var(--border-table-color)] text-[var(--contrast-main-text)] mb-6 p-4 rounded-lg shadow-md border">
