<div class="relative" wire:key="search-array-{{ $typeXString }}-{{ $selectX }}" x-data="{
    ...
    removeItem(index) {
        ...
        this.itemPenulis.splice(index, 1);
    },
    ...
    move(index, direction) {
        ...
        swap(this.itemPenulis, index, to);
    }
                    ...
                    <button type="button"
                        ...
                        if (items.includes({{ $x['id'] }})) {
                            ...
                            if (index !== -1) {
                                ...
                                itemPenulis.splice(index, 1);
                            }
                        } else {
                            addItem({{ $x['id'] }}, '{{ $x[$typeXString] }}', '{{ $x['kode'] }}', '{{ $x['penulis'] ?? null }}');
                        }
                    "
