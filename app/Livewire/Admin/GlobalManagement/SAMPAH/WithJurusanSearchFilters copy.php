...
trait WithJurusanSearchFilters
{
    ...
    public function selectJurusanForFilter($id)
    {
        ...
        if ($data) {
            ...
            $this->jurusan_kode = $data->kode_jr ?? $data->fakultas_rel?->kode_fk ?? 'UNI';
            $this->jurusan_name = 'Jurusan '.$data->nama_jurusan;
    ...
    //             $this->jurusan_kode = $exactMatch->kode_jr ?? $exactMatch->fakultas_rel?->kode_fk ?? 'UNI';
