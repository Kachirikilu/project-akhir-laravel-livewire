...
trait WithProdiModal
{
    ...
    public $showJurusanModal = false;

    public $showFakultasModal = false;
    ...
    public function addProdi($prodi)
    {
        ...
        } elseif ($prodi == 'fakultas') {
            $this->showFakultasModal = true;
        }
        if ($prodi === 'prodi') {
    ...
    public function editProdi($id, $type)
    {
        ...
        try {
            ...
            if ($prodi == 'prodi') {
                ...
                $this->showJurusanModal = true;
                $this->js("Flux.modal('jurusan-modal').show()");
            } elseif ($prodi == 'fakultas') {
                $this->showFakultasModal = true;
                $this->js("Flux.modal('fakultas-modal').show()");
            }
