    ...
    public function render()
    {
        ...
        try {
            ...
            $stats = [
                ...
                'scpmk-older-5' => (clone $querySCPMK)
                    ->where('created_at', '<', $fiveYearsAgo)
                    ->count(),
